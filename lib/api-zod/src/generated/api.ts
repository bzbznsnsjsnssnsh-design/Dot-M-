...
export const ProcessVideoBody = zod.object({
  ...
  "translationEngine": zod.enum(['openai', 'google', 'pollinations', 'groq']).optional().describe('Translation engine to use (openai, google, pollinations, groq)'),
  "forceAudioExtraction": zod.boolean().optional().describe('Skip captions and extract audio directly for AI transcription'),
  "sourceLanguage": zod.string().optional().describe('ISO language code of the video\'s original language (e.g. en, fr, ar). Omit for auto-detect.')
})
