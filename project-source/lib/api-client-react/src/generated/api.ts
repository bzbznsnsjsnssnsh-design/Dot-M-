...
export const getGetCookiesStatusQueryKey = () => {
  return [`/api/translate/cookies/status`] as const;
};

export const getGetCookiesStatusQueryOptions = <
  TData = Awaited<ReturnType<typeof getCookiesStatus>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof getCookiesStatus>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getCookiesStatus>>
  > = ({ signal }) => getCookiesStatus({ signal, ...requestOptions });
...
export type GetCookiesStatusQueryResult = NonNullable<
  Awaited<ReturnType<typeof getCookiesStatus>>
>;
...
export function useGetCookiesStatus<
  TData = Awaited<ReturnType<typeof getCookiesStatus>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
...
export const saveCookies = async (
  saveCookiesRequest: SaveCookiesRequest,
  options?: RequestInit,
  ...
  return customFetch<SuccessResponse>(getSaveCookiesUrl(), {
    ...
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(saveCookiesRequest),
  });
};

export const getSaveCookiesMutationOptions = <
  TError = ErrorType<ErrorResponse>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type SaveCookiesMutationResult = NonNullable<
  Awaited<ReturnType<typeof saveCookies>>
>;
...
export const getDeleteCookiesMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type DeleteCookiesMutationResult = NonNullable<
  Awaited<ReturnType<typeof deleteCookies>>
>;
